...
const CompanyList = () => {
  ...
  useEffect(() => {
    ...
    const fetchCompanies = async () => {
      try {
        // API 호출: 전체 기업 목록
        const companyResponse = await axios.get("http://jobbotdari.kro.kr:8072/jobbotdari/api/company");
    ...
    const fetchFavoriteCompanies = async () => {
      try {
        ...
        // API 호출: 관심 기업 목록
        const favoriteResponse = await axios.get("http://jobbotdari.kro.kr:8072/jobbotdari-user/api/user/interests", {
          headers: {
