...
const Profile = () => {
  ...
  const fetchProfile = async () => {
    try {
      setLoading(true);
      const response = await axios.get("http://gateway-server-8072-dns:8072/jobbotdari-user-8080-dns/api/profile", {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      await axios.patch("http://gateway-server-8072-dns:8072/jobbotdari-user-8080-dns/api/profile", profileDataToSend, {
